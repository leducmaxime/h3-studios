...
import { User, Mail, Lock, Phone, Music, MapPin, Building2, Hash, Home, CheckCircle2, AlertCircle } from "lucide-react";
  ...
  return (
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="pt-2">
            <Button
              type="submit"
              className="w-full h-11 text-sm font-semibold bg-primary text-black hover:bg-primary/90"
              disabled={saving}
            >
