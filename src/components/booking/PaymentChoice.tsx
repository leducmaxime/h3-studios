  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="text-center">
        <h3 className="text-xl font-bold lg:text-2xl">Comment souhaitez-vous payer ?</h3>
      ...
      <div className="grid gap-3 lg:gap-4 lg:grid-cols-2">
        <button
          ...
          className="group relative flex flex-col gap-3 rounded-xl border-2 border-primary/50 bg-primary/10 p-4 text-left transition-all hover:border-primary hover:bg-primary/20 lg:gap-4 lg:p-6"
        >
          ...
          <div className="mt-auto pt-3 lg:pt-4">
            <span className="inline-block rounded-lg bg-primary px-3 py-1.5 text-sm font-semibold text-black transition-all group-hover:bg-primary/90 lg:px-4 lg:py-2 lg:text-base">
         ...
         <button
           ...
           className="group flex flex-col gap-3 rounded-xl border-2 border-white/20 bg-white/15 p-4 text-left transition-all hover:border-white/40 hover:bg-white/15 lg:gap-4 lg:p-6"
         >
           <div className="flex items-center gap-3">
           ...
           <div className="mt-auto pt-3 lg:pt-4">
             <span className="inline-block rounded-lg border border-white/30 px-3 py-1.5 text-sm font-medium text-white/70 transition-all group-hover:border-white/50 group-hover:text-white lg:px-4 lg:py-2 lg:text-base">
               Réserver sans payer
             </span>
           </div>
         </button>
