              ...
              return (
                <li key={item.href}>
                  ...
                  >
                    ...
                    {sidebarCollapsed && (
                      <span className="pointer-events-none absolute left-full ml-2 rounded-md border border-zinc-700 bg-zinc-800 px-2 py-1 text-xs text-zinc-200 opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
                        {item.label}
                      </span>
                    )}
                  </a>
